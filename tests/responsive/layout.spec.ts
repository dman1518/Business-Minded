      ...
      await page.route("**/api/assessments/*", async (route) => {
        await route.fulfill({
          ...
          body: JSON.stringify({
            ...
            overallScore: 65,
            categoryScores: [
              { categoryId: "money", categoryName: "Money", score: 63 },
              { categoryId: "operations", categoryName: "Operations", score: 50 },
              { categoryId: "growth", categoryName: "Growth", score: 75 },
              { categoryId: "freedom", categoryName: "Freedom", score: 63 },
              { categoryId: "resilience", categoryName: "Resilience", score: 75 },
            ],
            biggestOpportunity: {
              categoryId: "money",
              categoryName: "Money",
              ...
              description:
                "Improving margin and revenue predictability is one of the fastest ways to increase what your business is worth, even when the underlying explanation runs long enough to wrap across several lines on a narrow screen.",
            },
            biggestConstraint: {
              categoryId: "operations",
              categoryName: "Operations",
              headline: "Inconsistent execution",
              description: "Without documented processes, quality depends on who is doing the work.",
            },
            topPriorities: [
              "Review your pricing and margins this month.",
              "Document your top two recurring processes as simple step-by-step guides this quarter.",
              "Identify the one marketing or sales activity that has worked best, and turn it into a repeatable process.",
            ],
      ...
      await page.route("**/api/assessments/*", async (route) => {
        await route.fulfill({
          ...
          body: JSON.stringify({
            ...
            topPriorities: ["Priority one.", "Priority two.", "Priority three."],
            confidenceLevel: "High",
          }),
        });
      });
