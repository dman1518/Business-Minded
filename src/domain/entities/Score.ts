 ...
 *  - "midrange-tied": every scoreable dimension is tied in the
 *    Developing or Solid band. The tie is disclosed in copy rather
 *    than claiming false precision about a unique constraint.
 *  - "none": no tie — normal single-dimension role selection applies.
 */
export type TieState = "none" | "all-low-tied" | "all-high-tied" | "midrange-tied";
